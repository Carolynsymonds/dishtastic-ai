              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={(e) => setTextareaValue(e.target.value)}
                    placeholder="Describe the food or recipe you want to generate..."
                    className="w-full min-h-[140px] pl-6 pr-12 py-4 pb-12 border border-input bg-background rounded-lg text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 resize-none"
                    rows={5}
                  />
